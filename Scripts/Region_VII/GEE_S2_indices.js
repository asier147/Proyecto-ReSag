var parcelas = ee.FeatureCollection('projects/resag-1/assets/Cereal_Comarca_VII');
...
Export.table.toDrive({
  collection: stats,
  description: 'Comarca_VII_indices_S2_convencional',
  fileFormat: 'CSV',
...
Export.table.toDrive({
  collection: stats,
  description: 'Comarca_VII_indices_S2_conservacion',
  fileFormat: 'CSV',
  folder: 'Proyecto_ReSag'
}); 
