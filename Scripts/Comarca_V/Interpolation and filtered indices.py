# -*- coding: utf-8 -*-
"""
Created on Fri May 10 18:31:09 2024
...
convencional_indices = pd.read_csv("Comarca_V_median_indices_S2_convencional.csv")
convencional_indices.rename(columns={'PRD_DESC': 'Cultivo'}, inplace=True)
conservacion_indices = pd.read_csv("Comarca_V_median_indices_S2_conservacion.csv")
...
df_unido_convencional.to_csv('convencional_V_indices_filtrado.csv', index=False)

df_unido_conservacion.to_csv('conservacion_V_indices_filtrado.csv', index=False)
