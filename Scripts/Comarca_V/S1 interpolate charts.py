...
convencional_bandas = pd.read_csv('convencional_S1_bandas_filtrado_V.csv')
conservacion_bandas = pd.read_csv('conservacion_S1_bandas_filtrado_V.csv')
...
na_counts = fich_trabajo_bandas.isna().sum()
print(na_counts)


fich_trabajo_bandas = fich_trabajo_bandas.dropna()
fich_trabajo_bandas = fich_trabajo_bandas[(fich_trabajo_bandas != 0).all(axis=1)]
...
fich_trabajo_bandas.to_csv('S1_bandas_filtrado_V.csv', index=False)